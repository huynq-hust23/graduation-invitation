/* Inline SVG only — no icon font, no emoji, no extra request.
   Each icon inherits currentColor and is marked decorative; the surrounding
   control always carries its own accessible name. */
...
export function PlaneIcon({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
      <path d="M2 13l19-7-7 19-2.5-8.5L2 13Z" />
    </svg>
  );
}
